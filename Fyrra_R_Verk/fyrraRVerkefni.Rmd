...
#j
ggplot(bsss_selected, aes(x = einflm, y = kaupverd, color = as.factor(ar))) +
...
property_type_counts <- bsss_selected %>%
  filter(tegund %in% c("Serbyli", "Fjolbyli")) %>%
  count(postnr, tegund)
